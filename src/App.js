    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Inter','Segoe UI',sans-serif", padding:20 }}>
      ...
      <div style={{ width:"100%", maxWidth:380 }}>
        <div style={{ textAlign:"center", marginBottom:36 }}>
          <img src="/icon.svg" alt="Aura Gym" style={{ width:64, height:64, objectFit:"contain", marginBottom:12}} />
        ...
        <div style={{ maxWidth:1080,margin:"0 auto" }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8 }}>
            <div style={{ display:"flex",alignItems:"center",gap:10 }}>
              <img src="/icon.svg" alt="Aura" style={{ width:32, height:32, objectFit:"contain"}} />
              <img src="/logo.svg" alt="Aura Gym" style={{ height:20, objectFit:"contain"}} />
            </div>
